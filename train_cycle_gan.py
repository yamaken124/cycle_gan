...
def main():
    ...
    # trainA = ImageDataset('face2smile/trainA', augmentation=True, image_size=178, final_size=args.size)
    # trainB = ImageDataset('face2smile/trainB', augmentation=True, image_size=178, final_size=args.size)
    # testA = ImageDataset('face2smile/testA', image_size=178, final_size=args.size)
    # testB = ImageDataset('face2smile/testB', image_size=178, final_size=args.size)
    trainA = ImageDataset('black2blond/trainA', augmentation=True, image_size=178, final_size=args.size)
    trainB = ImageDataset('black2blond/trainB', augmentation=True, image_size=178, final_size=args.size)
    testA = ImageDataset('black2blond/testA', image_size=178, final_size=args.size)
    testB = ImageDataset('black2blond/testB', image_size=178, final_size=args.size)
